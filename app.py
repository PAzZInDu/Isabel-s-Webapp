...
##function#
@st.cache_resource
def prediction(modelname, sample_image, IMG_SIZE=IMAGE_SIZE):
...
with st.expander("Web App 🌐"):
    ...
    st.write("This web app can predict whether a given MRI Scan image shows signs of alzheimer's such as Mild Demented, Moderate Demented, Non Demented and Very Mild Demented")
